...
from authentication.auth_exceptions.user_exceptions import UserNotAuthenticatedError
from authentication.export_types.validation_types.validation_result import (
    ValidationResult,
)
from authentication.models.user_models.user import User
from authentication.services.definitions import EnvironmentSettings
